...
class FavoriteDetailPage extends StatefulWidget {
  ...
  final int index;
  final String userId;
  FavoriteDetailPage({Key key, @required this.data, @required this.index, @required this.userId}) : super(key: key);
  @override
...
class _FavoriteDetailPageState extends State<FavoriteDetailPage> {
  ...
  Future<bool> isFavorite()async{
    var response = await http.post('http://alkalynxt.000webhostapp.com/udacoding_movie/gets/favorite/', body: {"userID":"${widget.userId}", "movieID": "${widget.data.movieId}"});
  ...
  Future<String> setFavorite()async{
    var response = await http.post('http://alkalynxt.000webhostapp.com/udacoding_movie/setfavorite/', body: {"userID":"${widget.userId}", "movieID": "${widget.data.movieId}"});
    if(response.statusCode==200){
